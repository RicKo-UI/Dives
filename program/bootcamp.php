    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                ?>
                <div class="col-4">
                    <a href="detail.php?id=<?php echo $data['id_program']; ?>" style="color: black;">
                        <div class="card kartu" style="width: 20rem;">
                            <img src="../Admin-page/gambar/<?php echo $data['gambar']; ?>" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $data['judul_program']; ?></h5>
                                <p class="card-text" style="font-size: 11px;"><?php echo $data['deskripsi']; ?></p>
                                <p style="font-size: 12px;color: #1363DF;">Tersedia</p>
                                <p class="price" ><?php echo $data['biaya']; ?></p>
                            </div>
                        </div>
                    </a>
                </div>
...
<script>
    ...
    $('#myTab button[data-target="#home"]').tab('show') // Select tab by name
