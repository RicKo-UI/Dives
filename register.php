<?php 
 ...
 if (isset($_POST['submit'])) {
    ...
    $sql = ("INSERT INTO tb_user VALUES ('','$name','$ins','$email','$pass','$level')");
...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-light sticky-top">
        <div class="container">
            <div class="logo">
                <a href='index.php'><img src="./assets/header logo.png" alt="Logo" width="124px"></a>
            </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item" style="padding-top: 7px;"><a href="login.php"
                        class="tombol-log">Login</a></li>
            </ul>
        </div>
    </nav>
        ...
        <section id="login" style="padding-top: 50px;">
            <div class="container mt-5 mb-5">
                <div class="row">
                    <div class="col-6">
                        <img class="img-login" src="./assets/login.png" width="90%"/>
                    </div>
                    <div class="col-6 mb-5">
                        <h2 class="judul-logsign"><b>Sign Up</b></h2>
                        <form action="register.php" method='post'>
                            <label class="lbl"><b>Nama Lengkap</b></label><br>
                            <input type="text" class="inp" id="email" name="name"><br>
                            <label class="lbl"><b>Institusi</b></label><br>
                            <input type="text" class="inp" id="pass" name="institusi"><br>
                            <label class="lbl"><b>Email</b></label><br>
                            <input type="text" class="inp" id="email" name="email"><br>
                            <label class="lbl"><b>Password</b></label><br>
                            <input type="password" class="inp" id="pass" name="pass"><br>
                            <input type="submit" value="Sign up" name='submit' class="tombol-3 mb-4" align="center">
    ...
    <section id="about">
        <div class="container ">
            <div class="row">
                <div class="col-2">
                    <a href='index.phpl'><img src="./assets/logo putih.png" alt="About" width="62%"
                            class="m-5"></a>
                </div>
                <div class="col-7">
